...
const UsersApp = (function () {
  ...
  function setupFilterModal() {
    ...
    if (!filterBtn) {
      ...
      filterBtn.id = 'filter-options-btn';
      // Inserta el SVG (24x24) en lugar del texto
      filterBtn.innerHTML = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" />
                              </svg>`;
      elements.searchInput.parentNode.insertBefore(filterBtn, elements.searchInput.nextSibling);
    }
